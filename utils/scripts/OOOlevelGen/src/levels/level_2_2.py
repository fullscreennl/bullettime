...
def render(name,bg):
    ...
    lb.addObject(Enemy.EnemySprite(x=2300, y=150,width=100,height=100,angle='0',restitution=0.2,static='false',friction=0.5,density=5 , classname='BlobSprite',firstframe='monsterblob.png'))
    lb.addObject(Teleporter.TeleporterSprite(level_id='leveldata/level_2_3'))
    lb.render()