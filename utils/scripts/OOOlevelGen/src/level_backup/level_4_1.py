...
def render(name,bg):
    ...
    lb.addObject(Alert.Alert(x=1000,y=160,width=100,height=320,name='ImageAlert',msg='right_touch.png'))
    lb.addObject(Alert.Alert(x=20,y=160,width=100,height=320,name='ImageAlert',msg='left_touch.png')) 
    #lb.addObject(Alert.Alert(x=500,y=160,width=100,height=320,msg='test_bg.png'))
    ##################################################################################################
    ...
    lb.addObject(ZoomTrigger.ZoomTriggerSprite(x=300,y=320-60,width=128,height=100,zoom_fact=0.1666666))
    lb.addObject(ZoomTrigger.ZoomTriggerSprite(x=300+115+50,y=250,width=100,height=500,zoom_fact=1.0))
