...
class ToxicUnit(PhysicsMixin.PhysicsMixin):

    def __init__(self,**kwargs):
        self.params = kwargs
        self.params['name'] = "ToxicUnit"
        self.process(kwargs)
        self.addDefault('classname','ToxicUnit')
...
if __name__ == "__main__":
    print ToxicUnit(friction=0.3,x=160,y=10,width=100, height=100,density=10,restitution=0.9).render()[0]
