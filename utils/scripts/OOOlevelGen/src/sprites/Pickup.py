...
class PickupSprite(PhysicsMixin.PhysicsMixin):
    
    def __init__(self,**kwargs):
        self.params = kwargs
        self.asp = float(kwargs['width']) / float(kwargs['height'])
        self.params['texture'] = "medical.png"
        self.params['name'] = "Pickup"
        self.process(kwargs)
        self.addDefault('classname','PickupSprite')
...
if __name__ == "__main__":
    print PickupSprite(x=160,y=10,width=100, height=100, static='true',classname='Crate',angle=45).render()[0]
