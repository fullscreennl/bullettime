...
class CrateSprite(PhysicsMixin.PhysicsMixin):
    
    def __init__(self,**kwargs):
        self.params = kwargs
        self.asp = float(kwargs['width']) / float(kwargs['height'])
        self.params['texture'] = "crate.png"
        self.params['name'] = "Crate"
        self.process(kwargs)
        self.addDefault('classname','CrateSprite')
...
if __name__ == "__main__":
    print CrateSprite(x=160,y=10,width=100, height=100, static='true',classname='Crate',angle=45).render()[0]
